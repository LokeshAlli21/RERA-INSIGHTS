...
import { CheckCircle, FileText, AlertTriangle, HelpCircle, Users, Building, ChevronDown, ChevronUp, ArrowUpRight } from 'lucide-react';
            ...
            <div ref={sectionRefs.contact} className="text-center bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 text-white p-12 rounded-3xl shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
                  Let RERA INSIGHTS handle your registration process professionally and efficiently.
                </p>
